...
const INVOKE_CHANNELS = new Set([
  ...
  'diagnostics:getCrashReportSummary',
  'diagnostics:copyCrashReports',
  'diagnostics:openCrashReportsFolder',
  'activity:get',
  'activity:clear',
  ...
  'routerInternet:getStatus',
  'routerInternet:getPublicIp',
  'routerInternet:setActiveProfile',
  'routerInternet:forgetProfile',
  'routerInternet:restart',
  'crypto:marketData',
  'crypto:search',
  'crypto:history',
  'crypto:historyRange',
